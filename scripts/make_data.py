...
if pkgutil.find_loader('address_entity_extraction') is None:
    ...
    if not src_dir.exists():
        raise EnvironmentError('Unable to import address_entity_extraction.')

    # add the source directory to the paths searched when importing
    sys.path.insert(0, str(src_dir))

# import the project package
import address_entity_extraction
